...
txm = 1;        % taxa de mutacão
txmRAND = 0.25; % outra taxa de mutaçao para ligar mais controladores
...
run('/run/media/mzk/mzkFILES/research/SEP24OP16C/_inf/NENY/load_NENY.m');  % pontos de operacão

load('/run/media/mzk/mzkFILES/research/Journal/_pops/pop50.mat'); % populacão inicial
